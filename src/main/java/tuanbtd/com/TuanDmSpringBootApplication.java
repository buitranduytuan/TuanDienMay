...
public class TuanDmSpringBootApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(TuanDmSpringBootApplication.class, args);
    }

    @Bean
    public ThanhVienValidator getThanhVienValidator() {
        return new ThanhVienValidator();
    }
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
        ...
        factoryBean.setPackagesToScan("tuanbtd.com.entity");// new String[] { "" }
